...
public class ParamCodes
{
     ...
     */
     ...
     /**
      * -Mx: Max Ratio for RDF and 3DMorse Indices.
      * RDF 10 by default
      * 3DMorse and 3DCorrelation 31 by default
      *
      */
     public static String rMx="-rMx";

     /**
      * -Mn: Min ratio for RDF and 3DMorse Indices.
      * RDF 2 by default
      * 3DMorse 1 by default
      */
     ...
     /**
      * -fmt: Output file format: 0 for arff, 1 for csv and 2 for bif, 2 by default
      */
